...
import 'setting_notifications_model.dart';
export 'setting_notifications_model.dart';

class SettingNotificationsWidget extends StatefulWidget {
  const SettingNotificationsWidget({super.key});
...
class _SettingNotificationsWidgetState
  ...
  late SettingNotificationsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingNotificationsModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'settingNotifications'});
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('SETTING_NOTIFICATIONS_arrow_back_rounded');
        ...
        children: [
          ...
          Padding(
            ...
            child: SwitchListTile.adaptive(
              ...
              subtitle: Text(
                'Receba notificações push do seu aplicativo regularmente.',
          ...
          Padding(
            ...
            child: FFButtonWidget(
              onPressed: () async {
                logFirebaseEvent('SETTING_NOTIFICATIONS_Button-Login_ON_TA');
