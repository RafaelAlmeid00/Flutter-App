...
class _SettingsProfileWidgetState extends State<SettingsProfileWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'settingsProfile'});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('SETTINGS_PROFILE_arrow_back_rounded_ICN_');
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('SETTINGS_PROFILE_SALVAR_ALTERAÇÕES_BTN_O');
                  ...
                  final smsCodeVal = _model.textController1.text;
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        'Perfil Atualizado. Verifique seu número pelo SMS.',
                        style: TextStyle(
